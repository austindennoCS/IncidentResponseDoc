...
- [Example Scenario Malware Removal from a Laptop Using NIST Incident Response](#example-scenario-malware-removal-from-a-laptop-using-sans-incident-response)
